...
gossip_test(Config) ->
    ...
    {ok, Block} =
        ct_rpc:call(FirstNode, test_utils, create_block, [ConsensusMembers, [SignedTx]]),
    ...
    GossipData =
        ct_rpc:call(FirstNode, blockchain_gossip_handler, gossip_data, [Swarm, Block]),

    ct_rpc:call(FirstNode, libp2p_group_gossip, send, [
        GossipGroup,
        ?GOSSIP_PROTOCOL_V1,
        GossipData
    ]),
