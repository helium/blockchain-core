...
lower_limit(_Config) ->
    ...
    case
        lists:sort(blockchain_state_channel_v1:summaries(Merged)) ==
            lists:sort(blockchain_state_channel_v1:summaries(OldMerged))
    of
        false ->
            ct:pal("~p ~p", [
                blockchain_state_channel_v1:summaries(Merged),
                blockchain_state_channel_v1:summaries(OldMerged)
            ]),
            ?assert(false);
        true ->
            ok
...
gen_sc() ->
    Summary1 = blockchain_state_channel_summary_v1:num_packets(
        ...
        blockchain_state_channel_summary_v1:num_dcs(
            2, blockchain_state_channel_summary_v1:new(<<"p1">>)
        )
    ),
    Summary2 = blockchain_state_channel_summary_v1:num_packets(
        4,
        blockchain_state_channel_summary_v1:num_dcs(
            4, blockchain_state_channel_summary_v1:new(<<"p1">>)
        )
    ),
    Summary3 = blockchain_state_channel_summary_v1:num_packets(
        1,
        blockchain_state_channel_summary_v1:num_dcs(
            1, blockchain_state_channel_summary_v1:new(<<"p2">>)
        )
    ),
    Summary4 = blockchain_state_channel_summary_v1:num_packets(
        1,
        blockchain_state_channel_summary_v1:num_dcs(
            1, blockchain_state_channel_summary_v1:new(<<"p3">>)
        )
    ),
    Summary5 = blockchain_state_channel_summary_v1:num_packets(
        1,
        blockchain_state_channel_summary_v1:num_dcs(
            1, blockchain_state_channel_summary_v1:new(<<"p4">>)
        )
    ),
    Summary6 = blockchain_state_channel_summary_v1:num_packets(
        1,
        blockchain_state_channel_summary_v1:num_dcs(
            1, blockchain_state_channel_summary_v1:new(<<"p4">>)
        )
