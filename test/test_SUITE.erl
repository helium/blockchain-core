...
htlc(_Config) ->
    ...
    ct:pal("=======Ledger: ~p", [blockchain_worker:ledger()]),

    NewHTLC0 = blockchain_ledger:find_htlc(Address, blockchain_ledger:htlcs(blockchain_worker:ledger())),

    ct:pal("NewHTLC0: ~p", [NewHTLC0]),
