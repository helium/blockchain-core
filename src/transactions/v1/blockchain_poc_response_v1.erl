...
-spec encode(
    Receipt :: blockchain_poc_witness_v1:poc_witness() | blockchain_poc_receipt_v1:poc_receipt()
) -> binary().
encode(#blockchain_poc_witness_v1_pb{} = Receipt) ->
    blockchain_txn_poc_receipts_v1_pb:encode_msg(#blockchain_poc_response_v1_pb{
        payload = {witness, Receipt}
    });
