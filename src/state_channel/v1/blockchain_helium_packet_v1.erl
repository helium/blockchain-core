...
make_routing_info_test() ->
    ?assertEqual(
        #routing_information_pb{data = {devaddr, 16#deadbeef}},
        make_routing_info({devaddr, 16#deadbeef})
    ),
    ?assertEqual(
        #routing_information_pb{data = {eui, #eui_pb{deveui = 16#deadbeef, appeui = 16#deadbeef}}},
        make_routing_info({eui, 16#deadbeef, 16#deadbeef})
    ).
