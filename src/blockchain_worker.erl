                          ...
                          try
                              ...
                              case {HonorQS, SyncPaused, BaseUrl} of
                                  ...
                                  {true, false, BaseUrl} ->
                                      ...
                                      lager:info("memory BEFORE snap download", [erlang:memory()]),
                                      lager:info("Successfully downloaded snap from ~p", [Url]),
                                      lager:info("memory AFTER snap download", [erlang:memory()]),
                                      {ok, Snap} = blockchain_ledger_snapshot_v1:deserialize(Hash,
                                                                                             BinSnap),
                                      SnapHeight = blockchain_ledger_snapshot_v1:height(Snap),
                                      lager:info("Successfully deserialized snap for height ~p", [SnapHeight]),
